...
namespace Wand
{
    public class MagicWandController : MMSingleton<MagicWandController>
    {
        ...
        private MagicWandShooter magicShooter;
        private WandGestureRecognizer wandGesture;
        ...
        protected override void Awake()
        {
            ...
            magicShooter = GetComponent<MagicWandShooter>();
        ...
        private void FixedUpdate()
        {
            ...
            if (isDrawing)
            {
                ...
                else if (Vector3.Distance(pointsList[pointsList.Count - 1], wandEndPosition.position) >
                         drawingSmoothness)
                {
                    pointsList.Add(wandEndPosition.position);
