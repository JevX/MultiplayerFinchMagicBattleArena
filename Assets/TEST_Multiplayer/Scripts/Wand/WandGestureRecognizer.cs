    ...
    private void CheckMatсhedGesture()
    {
        ...
        else
        {
            ...
            if (matchedImage.Name == GestureForIce)
            {
                ...
                if (!string.IsNullOrEmpty(FMODIceEnchantment)) FMODUnity.RuntimeManager.PlayOneShot(FMODIceEnchantment, transform.position);
            ...
            else if(matchedImage.Name == GestureForFire)
            {
                ...
                if (!string.IsNullOrEmpty(FMODFireEnchantment)) FMODUnity.RuntimeManager.PlayOneShot(FMODFireEnchantment, transform.position);
            ...
            else if(matchedImage.Name == GestureForKinetic)
            {
                ...
                if (!string.IsNullOrEmpty(FMODKineticEnchantment)) FMODUnity.RuntimeManager.PlayOneShot(FMODKineticEnchantment, transform.position);
            ...
            else if(matchedImage.Name == GestureForElectro)
            {
                ...
                if (!string.IsNullOrEmpty(FMODElectroEnchantment)) FMODUnity.RuntimeManager.PlayOneShot(FMODElectroEnchantment, transform.position);
            ...
            MagicWandController.Instance.ChangeMagicType(selectedType);
