    ...
    public class ImageGestureRecognizer : DigitalRubyShared.GestureRecognizer
    {
        ...
        private void CalculateScores()
        {
            ...
            if (MatchedGestureImage != null)
                Debug.Log("Matched image: " +MatchedGestureImage.Name);
        ...
        {
            Debug.Log("Image is going to be checked inside Recognizer");
        ...
        private bool CanExecute()
        {
            ...
            {
                Debug.Log("Gesture is not possible");
                return false;
            }
