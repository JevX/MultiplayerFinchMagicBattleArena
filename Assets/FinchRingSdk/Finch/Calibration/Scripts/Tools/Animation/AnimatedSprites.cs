...
public class AnimatedColor
{
    ...
    public static bool operator ==(AnimatedColor c1, AnimatedColor c2)
    {
...
public class AnimatedSprites : MonoBehaviour
{
    ...
    public AnimatedColor[] AnimatedColors = new AnimatedColor[0];
    ...
    public void SetAnimatedColors(AnimatedColor color, bool force)
    {
        SetAnimatedColors(new AnimatedColor[] { color }, force);
    }

    public void SetAnimatedColors(AnimatedColor[] colors, bool force = false)
    {
    ...
    public bool SameAnimations(AnimatedColor[] colors)
    {
