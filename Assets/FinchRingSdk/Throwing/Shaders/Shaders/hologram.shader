		...
		SubShader
			{
				...
				Pass
				{
					...
					struct v2f
					{
						...
						float4 color_tint:TEXCOORD1;

						float4 color_contrib0 :TEXCOORD4;
					...
					v2f vert(appdata v)
					{
						...
						float3 viewDir = normalize(UnityWorldSpaceViewDir(worldVertex.xyz));


						half dirVertex = (dot(worldVertex, normalize(float4(_Direction.xyz, 1.0))) + 1) / 2;
						...
						o.color_contrib0 = glow * 0.35 * _MainColor + rimColor;

						o.params.x = 2 * _Alpha * (scan + glow);
						o.params.y = 2 * _Brightness;

						o.color_contrib0.rgb *= o.params.y;
						o.color_contrib0.a = 0;

						o.color_tint = float4(o.params.yyy, 1) * _MainColor;
						o.color_tint.a = 1;

						o.params.z = _Time * _FlickerSpeed;
					...
					fixed4 frag(v2f i) : SV_Target
					{
						...
						fixed4 col  = texColor	* i.color_tint + i.color_contrib0;

						// Flicker
						fixed4 flicker = tex2D(_FlickerTex, i.params.z);
						col.a *= flicker.r;
