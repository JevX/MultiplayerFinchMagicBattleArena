...
namespace SpriteParticleEmitter
{
    ...
    public class UIParticleRenderer : MaskableGraphic
    {
        ...
        protected override void Awake()
        {
            ...
            /*
            var scale = new Vector2(Screen.width * 0.5f, Screen.height) / OriginSize;
            scale.x = Mathf.Max(scale.x, scale.y);

            rectTransform.localScale = new Vector3(scale.x, scale.x, 1);*/
        }
