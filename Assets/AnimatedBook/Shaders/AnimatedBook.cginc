...
fixed4 CalculateColors(fixed4 col, float3 data){
	...
	col.rgb = lerp(lerp(col.rgb, _ColorA.rgb, _ColorA.a * data.z), paperCol.rgb, lerpValue * data.z);
	#endif
				
	#ifdef _IMAGEMODE_ALPHABLEND
	col.rgb = lerp(lerp(col.rgb, _ColorA.rgb, _ColorA.a * data.z), paperCol.rgb, paperCol.a * data.z);
