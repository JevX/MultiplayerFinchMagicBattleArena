...
namespace com.guinealion.animatedBook {
	[ExecuteInEditMode]
	public class LightweightBookHelper : MMSingleton<LightweightBookHelper>
	{
		...
		public void GoToPage(int page, bool findClosest = true, float duration = 0.45f) {
			...
			FMODUnity.RuntimeManager.PlayOneShot(FMODPageSound, transform.position);
